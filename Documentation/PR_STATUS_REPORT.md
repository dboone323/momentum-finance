...
- #3, #6, #10, #11, #12, #15, #16, #20, #22, #25, #30, #31, #32, #35, #51, #53

Pending (remote refs exist):

- #1, #2, #4, #5, #7–#9, #13–#14, #17–#21, #23–#24, #26, #28, #33–#34, #37–#40, #42–#43, #45–#46, #48, #50
...
- Probe and merge clean PRs one-by-one (next: #26, #28), running Automation status after each. For conflicted PRs (#21, #23, #33+), apply conflict policy and prefer main for workflows and automation.
