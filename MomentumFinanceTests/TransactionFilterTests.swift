...
class TransactionFilterTests: XCTestCase {
    // Test setup method
    override func setUp() {
        super.setUp()
        // Initialize any necessary objects or configurations here
    }
    ...
    func testAllTransactionFilter() {
        ...
        // WHEN: We call the displayName property
        let displayName = filter.displayName
        
        // THEN: The displayName should be "All"
    ...
    func testIncomeTransactionFilter() {
        ...
        // THEN: The displayName should be "Income"
    ...
    func testExpenseTransactionFilter() {
        ...
        // THEN: The displayName should be "Expenses"
    ...
    func testTransferTransactionFilter() {
        ...
        // THEN: The displayName should be "Transfers"
    ...
    func testIdTransactionFilter() {
        ...
        // WHEN: We call the id property
        let id = filter.id
        
        // THEN: The id should be "all"
        XCTAssertEqual(id, "all")
    }
}
