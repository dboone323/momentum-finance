...
final class RootSearchEngineServiceTests: XCTestCase {
    ...
    func testSearchTransactions() {
        ...
        let tx1 = FinancialTransaction(title: "Groceries at Whole Foods", amount: -50, date: Date(), transactionType: .expense)
        tx1.account = account
    ...
    func testSearchSubscriptions() {
        ...
        let subscription = Subscription(name: "Netflix Premium", amount: 15.99, billingCycle: .monthly, nextDueDate: Date())
    ...
    func testSearchAllFilters() {
        ...
        let transaction = FinancialTransaction(title: "Test Transaction", amount: -50, date: Date(), transactionType: .expense)
