...
class TransactionDetailViewTests: XCTestCase {
    ...
    override func setUp() {
        ...
        // Create a mock FinancialTransaction instance with specific values
        let mockTransaction = FinancialTransaction(
            id: UUID(),
        ...
        // Create an instance of TransactionDetailView with the mock transaction
        viewModel = Features.Transactions.TransactionDetailView(transaction: mockTransaction)
    }
