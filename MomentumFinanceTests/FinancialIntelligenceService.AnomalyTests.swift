...
class FinancialIntelligenceServiceAnomalyTests: XCTestCase {
    ...
    override func tearDown() {
        super.tearDown()
        // Clean up any resources used in the test case
    }
    ...
    func testAnomalyDetection() {
        ...
        let date = Date(timeIntervalSince1970: 1633072800) // Example date
    ...
    func testAnomalyDetectionWithInvalidDate() {
        ...
        let date = Date(timeIntervalSince1970: 2033072800) // Example future date
