...
class TransactionPatternAnalyzerTests: XCTestCase {
    ...
    func testAnalyzePatterns_withRealData() {
        ...
        XCTAssertTrue(insights[0].description == "You tend to spend the most on Sundays. Consider this when planning your budget.")
        ...
        XCTAssertTrue(insights[1].description == "You tend to spend more around the 15th of each month. This could indicate bill payment patterns.")
