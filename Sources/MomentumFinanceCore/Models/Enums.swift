...
public enum AccountType: String, Codable, Sendable, CaseIterable {
    ...
    public var isAsset: Bool {
        switch self {
        case .checking, .savings, .investment, .cash, .retirement:
            return true
    ...
    public var isLiability: Bool {
        ...
        case .credit, .loan:
            return true
        case .checking, .savings, .investment, .cash, .other, .retirement:
            return false
        }
    }
}
