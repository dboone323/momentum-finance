...
public protocol AICachingService {
    ...
    func cacheResponse(key: String, response: String, metadata: [String: any Sendable]?) async
...
public protocol AIPerformanceMonitoring {
    ...
    ///   - metadata: Additional metadata
    func recordOperation(operation: String, duration: TimeInterval, success: Bool, metadata: [String: any Sendable]?) async
