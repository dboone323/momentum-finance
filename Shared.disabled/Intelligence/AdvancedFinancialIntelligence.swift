...
public class AdvancedFinancialIntelligence: ObservableObject {
    ...
    public struct EnhancedFinancialInsight: Identifiable, Hashable, Sendable {
        ...
        public let priority: InternalInsightPriority
        public let type: InternalInsightType
        ...
        public init(
            title: String,
            description: String,
            priority: InternalInsightPriority,
            type: InternalInsightType,
    ...
    public enum InternalInsightPriority: Int, CaseIterable, Hashable, Sendable {
        case low = 1
        case medium = 2
        case high = 3
        case critical = 4
    ...
    public enum InternalInsightType: Hashable, Sendable {
        case spendingAlert
    ...
    public struct CategoryTrend: Sendable {
        ...
        let priority: InternalInsightPriority
