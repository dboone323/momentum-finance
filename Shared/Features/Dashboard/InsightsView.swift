...
public struct InsightsView: View {
    ...
    @State private var selectedInsight: MomentumFinanceCore.FinancialInsight?
    @State private var filterPriority: MomentumFinanceCore.InsightPriority?
    @State private var filterType: MomentumFinanceCore.InsightType?
    ...
    private var filteredInsights: [MomentumFinanceCore.FinancialInsight] {
